...
sr.reveal('.home-data,.home-img,.home-social',{}); 
sr.reveal('.about-container-img,.about-container-data-description,.about-buttons,.about-container-data-info',{delay: 300}); 
sr.reveal('.skills-container-header,.skills-data',{ interval: 200}); 
sr.reveal('.qualification-sections',{interval: 100}); 
sr.reveal('.services-title',{delay:200});   
sr.reveal('.swiper-wrapper',{interval: 100}); 
sr.reveal('.project-data,.project-bg-img',{interval: 200}); 
sr.reveal('.contact-items',{interval: 200}); 